...
import com.tzb.faker4j.enums.BankCardType;
...
public class Bank {
     ...
     **/
    public static BankInfo bankInfo(BankCardType cardType) {
        boolean isDebit = cardType.name().equals(BankCardType.DEBIT.name());
        int index = Faker.random.nextInt(bankBin.length);
...
//        }
    ...
    public static JSONObject aliValid(String bankNo) {
        // 创建HttpClient实例
