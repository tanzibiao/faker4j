...
public class Car {
    ...
    public String carNo() {
        ...
        // 随机获取后五位随机序号
        while (count < 5) {
            String str2 = Faker.randomList(b);
        ...
        // 获取发证机关的随机号
        String plate = Faker.randomList(a) + sb;
        return plate.matches("^(([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z](([0-9]{5}[DF])|([DF]([A-HJ-NP-Z0-9])[0-9]{4})))|([京津沪渝冀豫云辽黑湘皖鲁新苏浙赣鄂桂甘晋蒙陕吉闽贵粤青藏川宁琼使领][A-Z][A-HJ-NP-Z0-9]{4}[A-HJ-NP-Z0-9挂学警港澳使领]))$") ? carNo() : plate; // 判断是否符合车牌规范，如果开头有连续的字母，则重新获取
    }
